...
public class ViewWishlistServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<WishlistItem> wishlistItems = dao.getWishlistItems(userId);
        dao.closeConnection();
        ...
        out.println("<title>View Wishlist</title>");
        ...
        // }
        out.println("<h3>Your Wishlist</h3>");
        if (wishlistItems.isEmpty()) {
            out.println("<p>Your wishlist is empty.</p>");
        } else {
            ...
            for (WishlistItem item : wishlistItems) {
                ...
                out.println("<td>");
                out.println("<form action='RemoveFromWishlistServlet' method='post' style='display:inline;'>");
